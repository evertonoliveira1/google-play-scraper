...
function checkFinished (opts, savedApps, nextToken, fSid) {
  ...
  // const url = 'https://play.google.com/_/PlayStoreUi/data/batchexecute?rpcids=qnKhOb&bl=boq_playuiserver_20190424.04_p0&hl=pt-BR&gl=br&authuser=0&soc-app=121&soc-platform=1&soc-device=1';

  const url = `https://play.google.com/_/PlayStoreUi/data/batchexecute?rpcids=qnKhOb&bl=boq_playuiserver_20190807.02_p0&hl=pt-BR&gl=br&authuser=0&soc-app=121&soc-platform=1&soc-device=1&${fSid}`;
  console.log('URL', url);
